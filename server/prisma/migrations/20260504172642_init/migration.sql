-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'SELLER', 'DRIVER');
...
-- CreateIndex
CREATE INDEX "Restock_userId_idx" ON "Restock"("userId");
...
-- CreateIndex
CREATE INDEX "RestockItem_productId_idx" ON "RestockItem"("productId");

-- CreateIndex
CREATE UNIQUE INDEX "RestockItem_restockId_productId_key" ON "RestockItem"("restockId", "productId");
